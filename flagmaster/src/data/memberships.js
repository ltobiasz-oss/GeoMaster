...
export const COUNTRIES = [
  ...
  { cca2: "be", name: "Belgia", eu: true, schengen: true, euro: true, nato: true,
    hook: "W Brukseli mieszczą się siedziby zarówno Unii Europejskiej, jak i NATO." },
  ...
  { cca2: "lu", name: "Luksemburg", eu: true, schengen: true, euro: true, nato: true,
    hook: "To właśnie w luksemburskiej wiosce Schengen podpisano w 1985 układ o zniesieniu granic." },
